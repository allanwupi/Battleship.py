...
Source: [**fnky / ANSI.md** on Github](https://gist.github.com/fnky/458719343aabd01cfb17a3a4f7296797).
...
- `232-255`:  greyscale from dark to light in 24 steps.

#### RGB Colors

More modern terminals supports [True color](https://en.wikipedia.org/wiki/Color_depth#True_color_.2824-bit.29) (24-bit RGB), which allows you to set foreground and background colors using RGB.
